...
export const COLOR_CLASSES = {
  ...
  primary: {
    ...
    neutral: 'bg-neutral-600 text-white focus:ring-neutral-500 hover:bg-neutral-700',
    ...
    orange: 'bg-orange-600 text-white focus:ring-orange-500 hover:bg-orange-700',
    amber: 'bg-amber-600 text-white focus:ring-amber-500 hover:bg-amber-700',
    yellow: 'bg-yellow-600 text-white focus:ring-yellow-500 hover:bg-yellow-700',
    ...
    emerald: 'bg-emerald-600 text-white focus:ring-emerald-500 hover:bg-emerald-700',
    ...
    indigo: 'bg-indigo-600 text-white focus:ring-indigo-500 hover:bg-indigo-700',
    violet: 'bg-violet-600 text-white focus:ring-violet-500 hover:bg-violet-700',
    purple: 'bg-purple-600 text-white focus:ring-purple-500 hover:bg-purple-700',
    fuchsia: 'bg-fuchsia-600 text-white focus:ring-fuchsia-500 hover:bg-fuchsia-700',
  ...
  secondary: {
    slate: 'border-2 border-slate-600 text-slate-600 focus:ring-slate-500 hover:bg-slate-600 hover:text-white',
    ...
    neutral: 'border-2 border-neutral-600 text-neutral-600 focus:ring-neutral-500 hover:bg-neutral-600 hover:text-white',
    stone: 'border-2 border-stone-600 text-stone-600 focus:ring-stone-500 hover:bg-stone-600 hover:text-white',
    red: 'border-2 border-red-600 text-red-600 focus:ring-red-500 hover:bg-red-600 hover:text-white',
    orange: 'border-2 border-orange-600 text-orange-600 focus:ring-orange-500 hover:bg-orange-600 hover:text-white',
    amber: 'border-2 border-amber-600 text-amber-600 focus:ring-amber-500 hover:bg-amber-600 hover:text-white',
    yellow: 'border-2 border-yellow-600 text-yellow-600 focus:ring-yellow-500 hover:bg-yellow-600 hover:text-white',
    lime: 'border-2 border-lime-600 text-lime-600 focus:ring-lime-500 hover:bg-lime-600 hover:text-white',
    green: 'border-2 border-green-600 text-green-600 focus:ring-green-500 hover:bg-green-600 hover:text-white',
    emerald: 'border-2 border-emerald-600 text-emerald-600 focus:ring-emerald-500 hover:bg-emerald-600 hover:text-white',
    ...
    indigo: 'border-2 border-indigo-600 text-indigo-600 focus:ring-indigo-500 hover:bg-indigo-600 hover:text-white',
    violet: 'border-2 border-violet-600 text-violet-600 focus:ring-violet-500 hover:bg-violet-600 hover:text-white',
    purple: 'border-2 border-purple-600 text-purple-600 focus:ring-purple-500 hover:bg-purple-600 hover:text-white',
    fuchsia: 'border-2 border-fuchsia-600 text-fuchsia-600 focus:ring-fuchsia-500 hover:bg-fuchsia-600 hover:text-white',
...
export const getVariantClasses = (
  ...
  return COLOR_CLASSES[variant][color as keyof typeof COLOR_CLASSES.primary] || COLOR_CLASSES[variant].blue;
};
